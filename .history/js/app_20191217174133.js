...
$(document).ready(function() {
  ...
  let sec = setInterval(() => {
    ...
    const faq = menuItem[0].textContent
    const termsOfUse = menuItem[1].textContent
    if (windowWidth < 415) {
      $('.subs__email__button').html('')
      $('footer__menu__item')[0].textContent = termsOfUse
      $('footer__menu__item')[1].textContent = termsOfUse
